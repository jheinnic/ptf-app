...
//
//public class ReservedBits implements ULIDRandomBitsStrategy {
...
//
////	public ReservedBits(ULIDRandomBitsStrategy baseRandomness) {
...
////	}
////
////	public static ReservedBits initStrategy(
////		ULIDRandomBitsStrategy baseRandomness, long firstLocation, int bitsUsed
////	) {
////		ReservedBits retVal = new ReservedBits(baseRandomness);
////		retVal.updateLocation(firstLocation, bitsUsed);
////		return retVal;
////	}
//	public ReservedBits(long reservation, int reservationBits, int sequenceBits) {
//		this.baseRandomness = null;
//		this.randomHi40 = baseRandomness.getRandomHi40();
//		this.randomLo40 = baseRandomness.getRandomLo40();
//		this.randomHi16 = (int) (this.randomHi40 >>> 24);
//		this.randomLo64 = (this.randomHi40 << 40) | this.randomLo64;
...
//		this.randomHi40 = (localHi64 & Constants.LOCATION_HI_40_MASK) >>> 24;
//		this.randomHi16 = (int) ((localHi64 & Constants.LOCATION_HI_16_MASK) >>> 48);
//
...
//		// pad is kept.
//		final long rndMaskMask = (0x1L << (offsetShift + 16)) - 1;
//		
