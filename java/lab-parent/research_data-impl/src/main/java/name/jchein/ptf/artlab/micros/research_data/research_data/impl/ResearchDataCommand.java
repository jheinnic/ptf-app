...
/**
  * This interface defines all the commands that the ResearchData aggregate supports.
  * <p>
  ...
  */
public interface ResearchDataCommand extends Jsonable {
  ...
  */
  ...
  @Value
  @JsonDeserialize
  final class UseGreetingMessage implements ResearchDataCommand, CompressedJsonable {
  ...
  */
  ...
  @Value
  @JsonDeserialize
  final class Hello implements ResearchDataCommand {
