...
/**
  * This interface defines all the commands that the ProtocolRegistry aggregate supports.
  * <p>
  ...
  */
public interface CanvasSizeCommand extends Jsonable {
  ...
  */
  ...
  @Value
  @JsonDeserialize
  final class UseGreetingMessage implements CanvasSizeCommand, CompressedJsonable {
  ...
  */
  ...
  @Value
  @JsonDeserialize
  final class Hello implements CanvasSizeCommand {
