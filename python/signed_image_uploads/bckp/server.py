...
from jchptf_image_upload.public_id_helper import PublicIdHelper
from typez import IUploadHelper, UploadOptions, AutoTagging, SignedUpload
from upload_helper import UploadHelper
from v1.signed_image_uploads_pb2 import CreateSignedUploadSingleRequest, \
    CreateSignedUploadBatchRequest, \
    SignedUploadSingleReply, SignedUploadBatchReply, FlaggedOptionalFeature, \
    OptionalUploadFeature, \
...
class ImageUploadSigningService(v1.signed_image_uploads_pb2_grpc.ImageUploadSigningServiceServicer):
    def __init__(self, upload_helper: IUploadHelper):
        self._upload_helper = upload_helper

    def createSignedUpload(self, request: CreateSignedUploadSingleRequest, context) -> \
            SignedUploadSingleReply:
