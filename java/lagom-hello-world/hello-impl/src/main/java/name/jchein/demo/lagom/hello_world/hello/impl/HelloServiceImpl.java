package name.jchein.demo.lagom.hello_world.hello.impl;
...
import name.jchein.demo.lagom.hello_world.hello.api.GreetingMessage;
import name.jchein.demo.lagom.hello_world.hello.api.HelloService;
import name.jchein.demo.lagom.hello_world.hello.impl.HelloCommand.*;
...
public class HelloServiceImpl implements HelloService {
  ...
  @Override
  public Topic<name.jchein.demo.lagom.hello_world.hello.api.HelloEvent> helloEvents() {
    ...
    return TopicProducer.taggedStreamWithOffset(HelloEvent.TAG.allTags(), (tag, offset) ->
      ...
      name.jchein.demo.lagom.hello_world.hello.api.HelloEvent eventToPublish;
      ...
      if (eventAndOffset.first() instanceof HelloEvent.GreetingMessageChanged) {
        ...
        eventToPublish = new name.jchein.demo.lagom.hello_world.hello.api.HelloEvent.GreetingMessageChanged(
