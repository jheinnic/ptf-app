...
/**
  * This interface defines all the commands that the Reporting aggregate supports.
  * <p>
  ...
  */
public interface ReportingCommand extends Jsonable {
  ...
  */
  ...
  @Value
  @JsonDeserialize
  final class UseGreetingMessage implements ReportingCommand, CompressedJsonable {
  ...
  */
  ...
  @Value
  @JsonDeserialize
  final class Hello implements ReportingCommand {
