...
/**
  ...
  */
public interface ComponentRegistryCommand extends Jsonable {
  ...
  */
  ...
  @Value
  @JsonDeserialize
  final class UseGreetingMessage implements ComponentRegistryCommand, CompressedJsonable {
  ...
  */
  ...
  @Value
  @JsonDeserialize
  final class ComponentRegistry implements ComponentRegistryCommand {
    public final String name;
    public final ActorRef<Greeting> replyTo;
    
    @JsonCreator
    ComponentRegistry(String name, ActorRef<Greeting> replyTo) {
