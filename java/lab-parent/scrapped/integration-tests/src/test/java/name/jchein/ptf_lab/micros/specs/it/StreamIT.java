package name.jchein.ptf_lab.micros.specs.it;
...
public class StreamIT {
    ...
    private static ComponentRegistryService helloService;
    ...
    public static void setup() {
        ...
        helloService = clientFactory.createDevClient(ComponentRegistryService.class, URI.create(SERVICE_LOCATOR_URI));
