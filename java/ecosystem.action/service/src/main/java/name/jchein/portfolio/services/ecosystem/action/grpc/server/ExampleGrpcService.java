package name.jchein.portfolio.services.ecosystem.action.grpc.server;
...
import name.jchein.portfolio.services.ecosystem.action.backend.IExampleDomainService;
