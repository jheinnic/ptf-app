package name.jchein.portfolio.services.ecosystem.action;
...
import name.jchein.portfolio.services.ecosystem.action.fixtures.EnableExampleGrpcUnitTest;
import name.jchein.portfolio.services.ecosystem.action.fixtures.GrpcFixtureData;

import name.jchein.portfolio.services.ecosystem.action.grpc.proto.CreateExampleRequest;
import name.jchein.portfolio.services.ecosystem.action.grpc.proto.ExampleGrpc;
import name.jchein.portfolio.services.ecosystem.action.backend.ExampleDomainService;
